          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <?php if (isset($_SESSION['error'])) { echo '<h2 style="color:red;">' . $_SESSION['error']; $_SESSION['error']=null; } else { ?><h2> Hello HOD ! What Would You Like to do Today ? <?php } ?> </h2>
...
<a href="addclass.php"><input type="button" class="btn btn-link btn-lg" value="Create Class">  </a>


<!-- Indicates a successful or positive action -->
<a href="addstudent.php"><input type="button" class="btn btn-link btn-lg" value="Add Student"> </a>

<!-- Contextual button for informational alert messages -->
<a href="generatereports.php"> <input type="button" class="btn btn-link btn-lg"  value="Generate Attendance Reports"> </a>
...
<!-- Contextual button for informational alert messages -->
<a href="addfaculty.php"> <input type="button" class="btn btn-link btn-lg"  value="Add Faculty"> </a>

<a href="viewassign.php"> <input type="button" class="btn btn-link btn-lg"  value="View & Assign Class"> </a>
