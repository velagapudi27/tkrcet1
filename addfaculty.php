              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/user.png" alt="">  <?php echo $_SESSION["login_user"]; ?>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Great! Lets Create a faculty Profile </h2>
...
<form method="Post" action="addedfaculty.php">					  
				 
	<p>Name : </p><input type="text" placeholder="enter name of faculty" name="facultyname" id="facultyid" required class="form-control"> <br>
	<p>Email : </p><input type="email" placeholder="enter email id of faculty" name="facultyemail" id="facultyemail" required class="form-control">
	
<br>
	<br>
	<input type="submit" id="Sub3" name="Sub3" value="Add Faculty" class="btn btn-success">
